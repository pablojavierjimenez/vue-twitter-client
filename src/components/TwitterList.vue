<template>
  <div class="twitterList">
    <div class="twitterList__unreade">hay {{ msg }} nuevos twits</div>
    <ul>
      <li class="twitterList_item"  v-for="twitItem in showedTwitItemList" :key="twitItem.id">
        <article class="twitterList_item__container">
          <span class="twitterList_item__user">
            <UserAvatar class="twitterList_item_user__image" :username="user.name" :userAvatarImageLink="twitItem.user.profile_image_url"></UserAvatar>
          </span>
          <TwitSingeItem :twitItemData="twitItem"></TwitSingeItem>
        </article>
      </li>
    </ul>
  </div>
...
import TwitSingeItem from '@/components/TwitSingeItem.vue'
